//Write functions to initialize and print details of an Employee and a Manager. Demonstrate the use of these functions in main.
...
struct Manager {
    struct Employee emp;  // A Manager is also an Employee
