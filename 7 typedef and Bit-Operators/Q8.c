/*In embedded systems, you often need to control specific bits in a hardware register to enable or disable features.
 Write a C program to use bitwise operators to set, clear, and toggle flags in a register*/
